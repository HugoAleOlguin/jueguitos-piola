...
window.setupFreeGamesUI = () => {
    // Inyectar el botón en el Nav (buscando el contenedor de botones)
    const navButtons = document.querySelector('.nav-buttons');
    const existingBtn = document.getElementById('btnFreeGames');
    const miniGamesBtn = document.getElementById('btnMiniGames');

    if (navButtons && !existingBtn) {
        ...
        if (miniGamesBtn && miniGamesBtn.parentElement === navButtons) {
            navButtons.insertBefore(btnFreeGames, miniGamesBtn);
        } else {
            navButtons.appendChild(btnFreeGames);
        }
